...
class SysInvoicesApi
{
     ...
     * @param  bool $include_documents Optinoele parameter (default false) waardoor het response-object voorzien kan worden van &#x60;InvoiceDocuments&#x60; (optional)
     ...
     */
    public function sysInvoicesByNumber($invoice_number, $include_documents = null, $include_child_invoice_ids = null, $include_corrected_invoice_ids = null)
    {
        list($response) = $this->sysInvoicesByNumberWithHttpInfo($invoice_number, $include_documents, $include_child_invoice_ids, $include_corrected_invoice_ids);
        return $response;
    }
     ...
     */
    public function sysInvoicesByNumberWithHttpInfo($invoice_number, $include_documents = null, $include_child_invoice_ids = null, $include_corrected_invoice_ids = null)
    {
        $returnType = '\Swagger\Client\Model\EcedoERPCRMInterfaceApiInvoice';
        $request = $this->sysInvoicesByNumberRequest($invoice_number, $include_documents, $include_child_invoice_ids, $include_corrected_invoice_ids);
     ...
     */
    public function sysInvoicesByNumberAsync($invoice_number, $include_documents = null, $include_child_invoice_ids = null, $include_corrected_invoice_ids = null)
    {
        return $this->sysInvoicesByNumberAsyncWithHttpInfo($invoice_number, $include_documents, $include_child_invoice_ids, $include_corrected_invoice_ids)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sysInvoicesByNumberAsyncWithHttpInfo($invoice_number, $include_documents = null, $include_child_invoice_ids = null, $include_corrected_invoice_ids = null)
    {
        $returnType = '\Swagger\Client\Model\EcedoERPCRMInterfaceApiInvoice';
        $request = $this->sysInvoicesByNumberRequest($invoice_number, $include_documents, $include_child_invoice_ids, $include_corrected_invoice_ids);
     ...
     */
    protected function sysInvoicesByNumberRequest($invoice_number, $include_documents = null, $include_child_invoice_ids = null, $include_corrected_invoice_ids = null)
    {
...
//                 }
     ...
     * @param  bool $include_documents Optinoele parameter (default false) waardoor het response-object voorzien kan worden &#x60;InvoiceDocuments&#x60; (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\EcedoERPCRMInterfaceApiInvoice[]
