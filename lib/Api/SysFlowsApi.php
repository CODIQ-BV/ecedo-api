...
class SysFlowsApi
{
     ...
     * @param  \Swagger\Client\Model\EcedoERPCRMInterfaceApiCancelFlowPostData $cancel_flow_post_data Optionele POST-data waarmee detailgedrag aangestuurd kan worden (required)
     * @param  string $cluster_reference Optionele parameter (default null) waardoor alleen de aanmedflow van het cluster met de meegegeven clusterreferentie wordt afgebroken. Als de clusterreferentie niet bestaat wordt een foutmelding teruggegeven. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     * @return object
     */
    public function sysFlowsStartApplicationFlow($organization_id, $cluster_reference = null, $reset_status = null, $cer_pre_notified = null, $skip_cooling_down_period = null)
    {
        list($response) = $this->sysFlowsStartApplicationFlowWithHttpInfo($organization_id, $cluster_reference, $reset_status, $cer_pre_notified, $skip_cooling_down_period);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function sysFlowsStartApplicationFlowWithHttpInfo($organization_id, $cluster_reference = null, $reset_status = null, $cer_pre_notified = null, $skip_cooling_down_period = null)
    {
        $returnType = 'object';
        $request = $this->sysFlowsStartApplicationFlowRequest($organization_id, $cluster_reference, $reset_status, $cer_pre_notified, $skip_cooling_down_period);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sysFlowsStartApplicationFlowAsync($organization_id, $cluster_reference = null, $reset_status = null, $cer_pre_notified = null, $skip_cooling_down_period = null)
    {
        return $this->sysFlowsStartApplicationFlowAsyncWithHttpInfo($organization_id, $cluster_reference, $reset_status, $cer_pre_notified, $skip_cooling_down_period)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sysFlowsStartApplicationFlowAsyncWithHttpInfo($organization_id, $cluster_reference = null, $reset_status = null, $cer_pre_notified = null, $skip_cooling_down_period = null)
    {
        $returnType = 'object';
        $request = $this->sysFlowsStartApplicationFlowRequest($organization_id, $cluster_reference, $reset_status, $cer_pre_notified, $skip_cooling_down_period);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sysFlowsStartApplicationFlowRequest($organization_id, $cluster_reference = null, $reset_status = null, $cer_pre_notified = null, $skip_cooling_down_period = null)
    {
        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
