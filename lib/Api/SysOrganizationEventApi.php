...
class SysOrganizationEventApi
{
     ...
     *
     * @param  \DateTime $desired_event_date Gewenste eventdatum (required)
     * @param  string $event_type Type event (required)
     * @param  string $usage_type Verbruikstype van de aansluiting (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DateTime
     */
    public function sysOrganizationEventGetFirstPossibleEventDate($desired_event_date, $event_type, $usage_type)
    {
        list($response) = $this->sysOrganizationEventGetFirstPossibleEventDateWithHttpInfo($desired_event_date, $event_type, $usage_type);
        return $response;
    }
     ...
     */
    public function sysOrganizationEventGetFirstPossibleEventDateWithHttpInfo($desired_event_date, $event_type, $usage_type)
    {
        $returnType = '\DateTime';
        $request = $this->sysOrganizationEventGetFirstPossibleEventDateRequest($desired_event_date, $event_type, $usage_type);
     ...
     */
    public function sysOrganizationEventGetFirstPossibleEventDateAsync($desired_event_date, $event_type, $usage_type)
    {
        return $this->sysOrganizationEventGetFirstPossibleEventDateAsyncWithHttpInfo($desired_event_date, $event_type, $usage_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sysOrganizationEventGetFirstPossibleEventDateAsyncWithHttpInfo($desired_event_date, $event_type, $usage_type)
    {
        $returnType = '\DateTime';
        $request = $this->sysOrganizationEventGetFirstPossibleEventDateRequest($desired_event_date, $event_type, $usage_type);
     ...
     */
    protected function sysOrganizationEventGetFirstPossibleEventDateRequest($desired_event_date, $event_type, $usage_type)
    {
