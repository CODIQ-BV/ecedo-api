...
class SysDebtorApi
{
     ...
     */
    public function sysDebtorGetDebtorProperties($organization_id, $debtor_id, $debtor_property)
    {
        list($response) = $this->sysDebtorGetDebtorPropertiesWithHttpInfo($organization_id, $debtor_id, $debtor_property);
        return $response;
    }
     ...
     */
    public function sysDebtorGetDebtorPropertiesWithHttpInfo($organization_id, $debtor_id, $debtor_property)
    {
        $returnType = '\Swagger\Client\Model\EcedoERPCRMInterfaceApiDebtorProperty[]';
        $request = $this->sysDebtorGetDebtorPropertiesRequest($organization_id, $debtor_id, $debtor_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sysDebtorGetDebtorPropertiesAsync($organization_id, $debtor_id, $debtor_property)
    {
        return $this->sysDebtorGetDebtorPropertiesAsyncWithHttpInfo($organization_id, $debtor_id, $debtor_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sysDebtorGetDebtorPropertiesAsyncWithHttpInfo($organization_id, $debtor_id, $debtor_property)
    {
        $returnType = '\Swagger\Client\Model\EcedoERPCRMInterfaceApiDebtorProperty[]';
        $request = $this->sysDebtorGetDebtorPropertiesRequest($organization_id, $debtor_id, $debtor_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sysDebtorGetDebtorPropertiesRequest($organization_id, $debtor_id, $debtor_property)
    {
        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
