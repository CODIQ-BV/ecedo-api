...
class EcedoERPCRMInterfaceApiConnectionPropertyPostData implements ModelInterface, ArrayAccess
{
    ...
    const CONNECTION_PROPERTY_TYPE_SECONDARY_ALLOCATION_POINTS_EA_NS = 'SecondaryAllocationPointsEANs';
    ...
    public function getConnectionPropertyTypeAllowableValues()
    {
        return [
            ...
            self::CONNECTION_PROPERTY_TYPE_SECONDARY_ALLOCATION_POINTS_EA_NS,
