...
class EcedoERPCRMInterfaceApiCertiQReport implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['certiq_ea_ns'] = isset($data['certiq_ea_ns']) ? $data['certiq_ea_ns'] : null;
    ...
    {
        return $this->container['certiq_ea_ns'];
    }

    /**
     * Sets certiq_ea_ns
     *
     * @param string $certiq_ea_ns certiq_ea_ns
     *
     * @return $this
     */
    public function setCertiqEaNs($certiq_ea_ns)
    {
        $this->container['certiq_ea_ns'] = $certiq_ea_ns;
