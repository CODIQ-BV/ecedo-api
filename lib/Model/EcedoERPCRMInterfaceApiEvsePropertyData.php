<?php
/**
 * EcedoERPCRMInterfaceApiEvsePropertyData
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * EcedoERPCRMInterfaceApiEvsePropertyData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcedoERPCRMInterfaceApiEvsePropertyData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ecedo.ERP.CRM.Interface.Api.EvsePropertyData';
    ...
    const PROPERTY_TYPE_GUEST_USAGE_ALLOWED = 'GuestUsageAllowed';
    ...
    {
        return [
            self::PROPERTY_TYPE_GUEST_USAGE_ALLOWED,
        ];
    }
